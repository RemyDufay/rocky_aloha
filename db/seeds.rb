...
@pierre_aventure = Rock.create!(user: @ambre, color: 'red', shape: 'pointy'  , name: 'Lara Croft', price: 20, description: "Compagnon de randonnées resiste aux chocs, durable, atteindra les sommets avec vous, vous guidera dans les forêts sombres ")
...
@precieuse = Rock.create!(user: @toto, color: 'grey', shape: 'round'  , name: 'Precieuse', price: 444, description: "Raffinée")
...
@confty = Rock.create!(user: @jade, color: 'blue', shape: 'sharp'  , name: 'Confty', price: 64, description: "Rassurante est toujours là pour toi ")
