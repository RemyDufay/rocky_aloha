...
Rock.create!(user: @mica, color: 'grey', shape: 'transparent'  , name: 'lola pierre de conversation', price: 206, description: "vous pouvez vous confier sans honte , vous pouvez baisser votre masque , gardera vos secrets pour toujours , ne vous interrompt pas ")

Rock.create!(user: @barite, color: 'grey', shape: 'big'  , name: 'bertrand le robuste ', price: 334, description: "garde du corps , poids musculation  , un seul lancer eloigne les haters  ")
