...
@mica= User.create!(email: 'mica@gmail.com', first_name: 'Mica' , last_name: 'Strassi', address: '5 Pl. Magellan, 44800 Saint-Herblain', password: "skuttérudite-smaltite-chloantite")
@ambre= User.create!(email: 'ambre.lapili@gmail.com', first_name: 'Ambre', last_name: 'Libage', address: '15 Rue de la Juiverie, 44000 Nantes', password: "2PbSCu2SSb2S3")
...
@raavi = Rock.create!(user: @toto, color: 'vert', shape: 'rond', name: 'Raavi', price: 422, description: "Vous aligne les chakras, détend votre corps   ")
